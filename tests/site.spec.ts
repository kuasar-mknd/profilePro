...
test.describe('Samuel Dulex Portfolio - E2E Tests', () => {
  ...
  test('should navigate to about page', async ({ page }) => {
    ...
    const aboutLink = page.locator('header nav').first().getByRole('link', { name: /À propos/i });
  ...
  test('should navigate to projects page', async ({ page }) => {
    ...
    const projectsLink = page.locator('header nav').first().getByRole('link', { name: /Projets/i });
