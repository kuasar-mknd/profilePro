...
4.  **Tests Playwright** :
    ...
    - Le serveur de dev est lancé automatiquement par Playwright via `webServer`. Si vous préférez le lancer manuellement (plus rapide), lancez `bun run dev` dans un autre terminal.
