...
4.  **Tests Playwright** :
    ...
    - Le serveur de dev est lancé automatiquement par Playwright. Si vous rencontrez des problèmes de timeout, vous pouvez lancer `bun run dev` manuellement avant les tests.
