 ...
 * Also escapes U+2028 and U+2029 to prevent JavaScript syntax errors in string literals.
 *
 * @param value - The value to serialize
 * @returns The JSON string with special characters escaped
 */
