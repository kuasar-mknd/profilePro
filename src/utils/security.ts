 ...
 * Also escapes U+2028 (Line Separator) and U+2029 (Paragraph Separator) which are valid in JSON
 * but cause syntax errors in JavaScript string literals.
 *
 * @param value - The value to serialize
 * @returns The JSON string with sensitive characters escaped
 */
