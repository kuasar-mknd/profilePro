...
metrics:
  - label: "Performance Lighthouse"
    value: "100/100"
  - label: "Vulnérabilités (bun audit)"
    value: "0"
...
- **Navigation instantanée** : préchargement des liens au survol et prérendu côté client (Speculation Rules), couplés aux View Transitions.
