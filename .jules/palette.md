...
## 2025-02-18 - Keyboard Shortcuts & Tooltips
**Learning:** Adding keyboard shortcuts (like Shift+D for Dark Mode) significantly delights power users, but they must be discoverable via tooltips (e.g., "Dark Mode (Shift+D)").
**Action:** Always pair global shortcuts with visible hints in tooltips or aria-labels.
