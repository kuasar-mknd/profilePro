...
## 2026-01-22 - Keyboard Shortcut Hints
**Learning:** To improve discoverability, elements with `aria-keyshortcuts` should include the shortcut in their `title` attribute (e.g., "Close (Esc)").
**Action:** Always append the keyboard shortcut to the tooltip text when `aria-keyshortcuts` is present.
